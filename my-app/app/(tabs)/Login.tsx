    ...
    import GoogleAuthButton from '/rn2/my-app/app/googleAuth'; // Cambié a "GoogleAuthButton" por convención
    import FacebookAuthButton from '/rn2/my-app/app/facebookAuth';
        ...
        return (
            ...
            <View style={styles.containerFondo}>
                <View style={styles.container}>
                    <Image
                        source={require('C:/rn2/my-app/assets/images/logo.png')}
                        style={styles.logo}
                    />
